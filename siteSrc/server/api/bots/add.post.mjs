...
export default defineEventHandler(async event => {
	...
	const OAuthHelper = event.context.oauth.getHelper(`Bearer ${event.context.session.accessToken}`)
	...
	const bot = await event.context.oauth.getUser(body.botid).catch(e=>{})
